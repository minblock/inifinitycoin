...
"""Verify that starting infinitycoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start infinitycoin with -h for help text")
        ...
        self.log.info("Start infinitycoin with -version for version information")
        ...
        self.log.info("Start infinitycoind with -fakearg to make sure it does not start")
