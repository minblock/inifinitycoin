# Support for Output Descriptors in Infinitycoin Core

Since Infinitycoin Core v0.17, there is support for Output Descriptors. This is a
...
on Infinitycoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Infinitycoin Core wallets, a convenience function `combo` is
