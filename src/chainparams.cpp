...
{
    const char* pszTimestamp = "4/20/2020 Provigen.et: Now accepting pocket rockets";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1586085031, 348429, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x6f2760ea9b18198c96cd5721b5166aeee9bf11b3c47f17bf559f6a946959b46d"));
        assert(genesis.hashMerkleRoot == uint256S("0x7e4acf992fef93c14bdd5846af813ced1fd67fcb83169afbdf7b1eba7b46eeec"));
        ...
        vSeeds.emplace_back("seed-a.infinitycoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.infinitycointools.com");
        vSeeds.emplace_back("dnsseed.infinitycoinpool.org");
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 25807, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xbe75d7c5a5cb5bd1b60d5838261cf2a982852d9ae34f70a69b5b705f2d80de59"));
        assert(genesis.hashMerkleRoot == uint256S("0x7e4acf992fef93c14bdd5846af813ced1fd67fcb83169afbdf7b1eba7b46eeec"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.infinitycointools.com");
        vSeeds.emplace_back("seed-b.infinitycoin.loshan.co.uk");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xf828c2a4df7a9b1de93a56ac4401b0acb92726a696fe52a6d91cb109c1e80cba"));
        assert(genesis.hashMerkleRoot == uint256S("0x7e4acf992fef93c14bdd5846af813ced1fd67fcb83169afbdf7b1eba7b46eeec"));
