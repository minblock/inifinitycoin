...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " infinitycoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  infinitycoin-tx [options] <hex-tx> [commands]  Update hex-encoded infinitycoin transaction\n" +
            "or:     infinitycoin-tx [options] -create [commands]   Create hex-encoded infinitycoin transaction\n" +
            "\n";
